    ...
    <section id="hardware" className="relative bg-[var(--color-bg-alt)] py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          ...
          <article className="relative flex flex-col overflow-hidden rounded-3xl border border-dashed border-[var(--color-overlay)]/15 bg-gradient-to-br from-[var(--color-blue)]/10 to-transparent p-2 sm:flex-row">
