        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
              ...
              {TRUST_CHIPS.map((chip) => (
                <div
                  ...
                  className={[
                    ...
                    chip === 'Comprehensive service for the device and the software'
          ...
          <div className="relative lg:justify-self-end">
            ...
            <div className="relative rounded-[2rem] border border-[var(--color-overlay)]/10 bg-[var(--color-overlay)]/[0.03] p-4 shadow-[var(--shadow-glow)] backdrop-blur">
              ...
              <div className="absolute -top-8 -right-5 flex items-center gap-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 shadow-xl sm:-right-20">
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--color-primary)]/15 text-[var(--color-primary)]">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="text-left">
                  <p className="text-xs text-[var(--color-overlay)]/50">Maintenance</p>
                  <p className="text-sm font-semibold">Hardware &amp; software</p>
                </div>
              </div>
            </div>
          </div>
