...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[var(--color-ink)] pt-40 pb-24 lg:pt-48 lg:pb-32">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 h-[36rem] w-[60rem] -translate-x-1/2 rounded-full bg-[var(--color-violet)]/25 blur-[120px]" />

      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div>
            <span className="eyebrow rounded-full border border-white/15 bg-white/5 px-4 py-2 text-[var(--color-volt)]">
            ...
            <h1 className="mt-6 text-balance font-display text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl">
              Streamline Your Business with <span className="text-[var(--color-volt)]">Tavlii POS</span>
            </h1>
          ...
          <div className="relative lg:justify-self-end">
            <div className="absolute -inset-6 -z-10 rounded-[2.5rem] bg-gradient-to-br from-[var(--color-volt)]/20 via-transparent to-[var(--color-violet)]/30 blur-2xl" />
            <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.03] p-4 shadow-[var(--shadow-glow)] backdrop-blur">
              ...
              <div className="absolute -bottom-5 -left-5 flex items-center gap-3 rounded-2xl border border-white/10 bg-[var(--color-surface)] px-4 py-3 shadow-xl sm:-left-8">
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--color-volt)]/15 text-[var(--color-volt)]">
