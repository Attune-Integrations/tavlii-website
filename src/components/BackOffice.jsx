    ...
    <section id="analytics" className="relative bg-[var(--color-bg)] py-24 lg:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <span className="eyebrow text-[var(--color-primary)]">Back Office &amp; Analytics</span>
        ...
        <div className="mt-16 grid gap-5 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-[var(--color-primary)]/25 bg-gradient-to-br from-[var(--color-secondary)]/20 via-[var(--color-surface)] to-[var(--color-surface)] p-7 lg:col-span-2">
            <div className="pointer-events-none absolute -top-10 -right-10 h-40 w-40 rounded-full bg-[var(--color-primary)]/20 blur-3xl" />
